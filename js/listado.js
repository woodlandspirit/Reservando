...
Listado.prototype.buscarRestaurante = function(id) {
    ...
    let resultadoRestaurante = this.restaurantes.find(restaurant => restaurant.id === id);
...
Listado.prototype.obtenerHorarios = function() {
    ...
    var horarios = [];
    arregloHorarios.forEach(function(array) {
    ...
    var horariosSinRepetir = eliminarElementosRepetidos(horarios)
